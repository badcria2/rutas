...
// =========================================
// RUTAS PARA GESTIONAR RUTAS FAVORITAS
// =========================================
 ...
 */
router.get('/ruta-favorita', async (req, res) => {
    try {
 ...
 */
router.get('/ruta-favorita/:id', async (req, res) => {
    try {
 ...
 */
router.post('/ruta-favorita', async (req, res) => {
    try {
        // Validar datos de entrada
 ...
 */
router.put('/ruta-favorita/:id', async (req, res) => {
    try {
        const rutaId = req.params.id;
 ...
 */
router.delete('/ruta-favorita/:id', async (req, res) => {
    try {
        const rutaId = req.params.id;
