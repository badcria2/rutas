...
CREATE TABLE IF NOT EXISTS geocoding.security_points (
...
CREATE TABLE IF NOT EXISTS geocoding.incidents (
    id SERIAL PRIMARY KEY,
    type VARCHAR(50) NOT NULL,
    description TEXT,
    latitude DECIMAL(10, 7) NOT NULL,
...
CREATE TABLE IF NOT EXISTS geocoding.favorite_routes (
    id SERIAL PRIMARY KEY,
