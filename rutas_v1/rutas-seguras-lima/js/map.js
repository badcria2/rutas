...
// Módulo MapManager para evitar conflictos con el objeto Map nativo de JavaScript
const MapManager = (function() {
     ...
     * @param {Array} center - Coordenadas del centro [lat, lng]
     * @param {number} zoom - Nivel de zoom inicial
     * @returns {Object} - Instancia del mapa de Leaflet
     */
    function init(containerId, center = LIMA_CENTER, zoom = DEFAULT_ZOOM) {
...
console.log('Módulo MapManager cargado correctamente');